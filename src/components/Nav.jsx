        ...
        <div>
            <div className="navbar bg-base-100 shadow-lg px-4 ">
                <div className="flex-1">
                    <a className="btn btn-ghost text-3xl font-bold gap-0 text-secondary">Byte <span className="text-primary">Blaze</span> </a>
                </div>
                <div className="flex-none">
                    <ul className="menu menu-horizontal px-1 text-xl gap-12 ">

                        <NavLink to='/home' className={({ isActive }) => isActive ? ` text-primary font-bold` : `font-bold`}  ><a>HOME</a></NavLink>
